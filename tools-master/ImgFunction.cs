...
namespace Tools
{
    ...
    public static unsafe class ImgFunction
    {
        ...
        public static unsafe Bitmap ConvertToBitmapIndexed(Bitmap img, List<Color> palette)
        {
        ...
        public static unsafe Bitmap ConvertToBitmapIndexed(Bitmap img)
        {
            List<Color> palette = new List<Color>(32);
            GetImgColor(img, palette);
            return ConvertToBitmapIndexed(img, palette);
        }
